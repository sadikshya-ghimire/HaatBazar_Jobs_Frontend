      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="px-6 py-6" style={{ backgroundColor: '#00B8DB' }}>
          ...
          <View className="flex-row items-center justify-between mb-2">
            <Text className="text-white text-sm">Step 1 of 3</Text>
            <Text className="text-white text-sm">33%</Text>
          </View>
        ...
        <View className="items-center px-6 py-12">
          <View className="w-full" style={{ maxWidth: 500 }}>
            ...
            <Text className="text-gray-600 text-sm mb-8">
              Upload a clear photo of yourself. This helps workers recognize you as an employer.
            </Text>
...
export default EmployerRegistrationStep1;
