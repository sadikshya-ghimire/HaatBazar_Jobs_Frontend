...
interface EmployerRegistrationStep2Props {
  onBack?: () => void;
  onContinue?: (data: { nidNumber: string; nidFront: string; nidBack: string }) => void;
  onSkip?: () => void;
}

const EmployerRegistrationStep2 = ({ onBack, onContinue, onSkip }: EmployerRegistrationStep2Props) => {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="px-6 py-6" style={{ backgroundColor: '#00B8DB' }}>
          ...
          <View className="flex-row items-center justify-between mb-2">
            <Text className="text-white text-sm">Step 2 of 3</Text>
            <Text className="text-white text-sm">67%</Text>
          </View>
        ...
        <View className="items-center px-6 py-8">
          <View className="w-full" style={{ maxWidth: 500 }}>
            ...
            <Text className="text-gray-600 text-sm mb-8">
              Your NID helps verify your identity and build trust with workers.
            </Text>
...
export default EmployerRegistrationStep2;
